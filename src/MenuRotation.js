const menu = () => {
    ...
    bottomCircle.addEventListener('click',function(){
        ...
        else if(circle.classList.contains('rotation-left-180')){
            circle.classList.remove('rotation-left-180')
        }
        else if(circle.classList.contains('rotation-left-90')){
            circle.classList.remove('rotation-left-90')
            circle.classList.add('rotation-left-180')
        }
        else if(circle.classList.contains('rotation-right-90')){
    ...
    rightCircle.addEventListener('click',function(){
        ...
        else if(circle.classList.contains('rotation-right-180')){
            circle.classList.remove('rotation-right-180')
